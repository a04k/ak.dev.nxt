  ...
  return (
    <main className="mb-16">
      <div className="font-amarga mb-10 dark:text-emerald-600 text-emerald-800" id="intro">
        <h1 className="text-5xl" >Ahmed Khaled</h1>
        <h2 className="text-2xl">Sophomore Computer Science Student , Junior Web Developer </h2> 
      </div>
      <div className="resumeSection">
        <h2 className='resumeSectionTitle'>Education</h2><hr/>
          <div className="resumeItem">
            <h3 className="resumeContentTitle"> Ain Shams University <span className="float-right">Cairo, Egypt</span></h3>
      ...
      <div className="resumeItem">
        <p className="resumeContentTitle">OSC FCIS<span className="float-right">2024 Season</span></p>
          <p className="resumeContent">Web Development Team Member </p>      
        <p className="resumeContentTitle">Freelance Graphic Designer <span className="float-right">2018-Current</span></p>
      ...
      <div className="resumeItem">
      <p className="resumeContentTitle">NAVERIS<span className="float-right">NASA SPACE APPS 2023</span></p>
